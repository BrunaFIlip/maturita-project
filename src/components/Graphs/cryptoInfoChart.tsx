  ...
  if(!loading){
    ...
    return ( <>
      ...
      <><STable>
            ...
            <STr></STr>
            <STr><th>24 hodin:</th><STh percentage={data[0]["market_data"]['price_change_percentage_24h']}>{data[0]["market_data"]['price_change_percentage_24h'] == undefined || data[0]["market_data"]['price_change_percentage_24h'] == null ? "Záznam chybí" : (data[0]["market_data"]['price_change_percentage_24h'] + "%")}</STh></STr>
            <STr><th>7 dní:</th><STh percentage={data[0]["market_data"]['price_change_percentage_7d']}>{data[0]["market_data"]['price_change_percentage_7d'] == undefined || data[0]["market_data"]['price_change_percentage_7d'] == null ? "Záznam chybí" : (data[0]["market_data"]['price_change_percentage_7d'] + "%")}</STh></STr>
            <STr><th>30 dní:</th><STh percentage={data[0]["market_data"]['price_change_percentage_30d']}>{data[0]["market_data"]['price_change_percentage_30d'] == undefined || data[0]["market_data"]['price_change_percentage_30d'] == null ? "Záznam chybí" : (data[0]["market_data"]['price_change_percentage_30d'] + "%")}</STh></STr>
            <STr><th>60 dní:</th><STh percentage={data[0]["market_data"]['price_change_percentage_60d']}>{data[0]["market_data"]['price_change_percentage_60d'] == undefined || data[0]["market_data"]['price_change_percentage_60d'] == null ? "Záznam chybí" : (data[0]["market_data"]['price_change_percentage_60d'] + "%")}</STh></STr>
            <STr><th>200 dní:</th><STh percentage={data[0]["market_data"]['price_change_percentage_200d']}>{data[0]["market_data"]['price_change_percentage_200d'] == undefined || data[0]["market_data"]['price_change_percentage_200d'] == null ? "Záznam chybí" : (data[0]["market_data"]['price_change_percentage_200d'] + "%")}</STh></STr>
            <STr><th>1 rok:</th><STh percentage={data[0]["market_data"]['price_change_percentage_1y']}>{data[0]["market_data"]['price_change_percentage_1y'] == undefined || data[0]["market_data"]['price_change_percentage_1y'] == null ? "Záznam chybí" : (data[0]["market_data"]['price_change_percentage_1y'] + "%")}</STh></STr>
          </STable><tfoot></tfoot></>
